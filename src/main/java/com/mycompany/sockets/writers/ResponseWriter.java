package com.mycompany.sockets.writers;

import com.mycompany.sockets.pojos.HttpResponse;
import com.mycompany.sockets.pojos.HttpStatusCode;
import com.mycompany.app.CommandRunner;
...
public class ResponseWriter {
    ...
    private static Optional<String> getResponseString(final Object entity) {
        ...
        if (entity instanceof CommandRunner cm) {
          return Optional.of(cm.execCommand());
        }
